...
(function () {
      ...
      <div class="bili-3d-btn">
        <svg width="25" height="25" viewBox="0 0 48 48">
          ...
          <g transform="translate(24,24)">
            <!-- 扫帚柄 -->
            <line x1="-6" y1="6" x2="8" y2="-8" stroke="url(#bili-icon-grad)" stroke-width="2.5" stroke-linecap="round"/>
            <!-- 扫帚头 -->
            <g transform="rotate(-45)">
              <rect x="-10" y="-2" width="8" height="4" rx="2" fill="url(#bili-icon-grad)"/>
              <line x1="-9" y1="-1" x2="-9" y2="1" stroke="#fff" stroke-width="0.8" opacity="0.8"/>
              <line x1="-7" y1="-1" x2="-7" y2="1" stroke="#fff" stroke-width="0.8" opacity="0.8"/>
              <line x1="-5" y1="-1" x2="-5" y2="1" stroke="#fff" stroke-width="0.8" opacity="0.8"/>
              <line x1="-3" y1="-1" x2="-3" y2="1" stroke="#fff" stroke-width="0.8" opacity="0.8"/>
            </g>
            <!-- 清理效果星星 -->
            <g opacity="0.9">
              <path d="M-8,-6 L-7,-5 L-8,-4 L-9,-5 Z" fill="#fff" opacity="0.8">
                <animateTransform attributeName="transform" type="rotate" values="0;360" dur="3s" repeatCount="indefinite"/>
              </path>
              <path d="M6,-2 L7,-1 L6,0 L5,-1 Z" fill="#fff" opacity="0.7">
                <animateTransform attributeName="transform" type="rotate" values="0;-360" dur="4s" repeatCount="indefinite"/>
              </path>
              <circle cx="2" cy="-8" r="1" fill="#fff" opacity="0.6">
    ...
    function updateMenuPosition() {
        ...
        const isTop = btnCenterY < centerY;

        let left, top;
        const offset = 15; // 菜单与按钮的间距
        ...
        top = Math.max(10, Math.min(top, winH - menuRect.height - 10));
    ...
    style.innerHTML = `
      ...
      .bili-3d-glow {
        ...
        border-radius: 50%;
        box-shadow:
          0 0 12px 2px #a18cd188,
          0 0 24px 5px #a18cd144,
          0 0 36px 7px #a18cd122;
        pointer-events: none;
        opacity: 0.8;
      ...
      @keyframes biliGlow {
        0% {
          opacity: 0.6;
          box-shadow:
            0 0 9px 2px #a18cd166,
            0 0 18px 4px #a18cd133,
            0 0 27px 5px #a18cd111;
        }
        100% {
          opacity: 1;
          box-shadow:
            0 0 18px 4px #a18cd1aa,
            0 0 36px 7px #a18cd166,
            0 0 54px 11px #a18cd133;
        }
      }
      @keyframes biliRing {
    ...
    function applyTheme(theme) {
        ...
        .bili-3d-btn {
          box-shadow:
            0 0 0 3px #fff6 inset,
            0 0 0 1px ${t.accent}44,
            0 6px 24px ${t.accent}cc,
            0 2px 8px #fff8,
            0 0 60px ${t.accent}33;
          background: radial-gradient(circle at 30% 30%, #fff8, ${t.accent}44);
          border: none;
          overflow: visible;
        }
        .bili-3d-btn:hover {
          filter: drop-shadow(0 12px 48px ${t.accent}ee) drop-shadow(0 4px 16px #fff8);
          box-shadow:
            0 0 0 4px #fff8 inset,
            0 0 0 2px ${t.accent}66,
            0 12px 48px ${t.accent}ee,
            0 4px 16px #fff8,
            0 0 80px ${t.accent}55;
        }
        .bili-3d-glow {
          box-shadow:
            0 0 20px 4px ${t.accent}88,
            0 0 40px 8px ${t.accent}44,
            0 0 60px 12px ${t.accent}22;
        }
        .bili-3d-ring {
        ...
        @keyframes biliGlow {
          0% {
            opacity: 0.6;
            box-shadow:
              0 0 15px 3px ${t.accent}66,
              0 0 30px 6px ${t.accent}33,
              0 0 45px 9px ${t.accent}11;
          }
          100% {
            opacity: 1;
            box-shadow:
              0 0 30px 6px ${t.accent}aa,
              0 0 60px 12px ${t.accent}66,
              0 0 90px 18px ${t.accent}33;
          }
        }
      `;
        document.head.appendChild(floatBtnThemeStyle);
